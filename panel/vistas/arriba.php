...
/*
revisar las comillas de las variables de seccion y la sintaxis que tiene un conflicto;
*/
$correo = $_SESSION['correo'];
$pass = $_SESSION['pass'];
$nameUser = "SELECT * from reg_usuario WHERE correo = '$correo' AND password = '$pass' ";
/*obtenemos los datos del usuario para poder presentarlos en diferentes lugares */
$consulta = mysqli_query($conexion, $nameUser);
$usuario = mysqli_fetch_assoc($consulta);/*combertimos la variable usuario en un arreglo con los datos del usuario logueado*/
?>
<!--inicio de la estrucctura html-->
<!DOCTYPE html>
<html lang="es">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <li class="nav-item">
                <a class="nav-link collapsed" href="#" data-toggle="collapse" data-target="#collapseTwo"
                    ...
                    <!--<i class="fas fa-fw fa-cog"></i>--> <!--icono de tuerca-->
                    ...
                    <ul class="navbar-nav ml-auto">
                                ...
                                <a class="dropdown-item d-flex align-items-center" href="#">
                                    <div class="mr-3">
                                        <div class="icon-circle bg-primary">
                                            <i class="fas fa-file-alt text-white">rt</i>
                                        </div>
                                    </div>
                                    <div>
                        ...
                        <li class="nav-item dropdown no-arrow">
                            <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button"
                                data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                <!--/////////////////////////////////////////////////////////////////////////////////-->
                                <!--aqui mostramos el nombre de usuario en el dashboard-->
                            <span class="mr-2 d-none d-lg-inline text-gray-600 small"><?php echo $usuario["nombre"]; ?></span>
                                <img class="img-profile rounded-circle"
                                    src="<?php echo $usuario["foto"];?>">    <!-- aqui mostramos la foto de perfil-->
                            </a>
